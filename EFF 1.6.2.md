...
.hotgraphic .hotgraphic__inner .hotgraphic__widget .hotgraphic__pin-item-container .hotgraphic__pin-item .hotgraphic__pin.is-visited .icon:before {
...
.background-colour1 .truefalseContainer .component__instruction-inner {
    color:#4F6074 !important;
}


.background-colour2 .mcqContainer .component__instruction-inner, 
.background-colour2 .openTextInput .component__instruction-inner, 
.background-colour2 .graphicalMCQ .component__instruction-inner, 
.background-colour2 .truefalseContainer .component__instruction-inner, 
.background-colour2 .sliderContainer .component__instruction-inner, 
.background-colour2 .stackerContainer .component__instruction-inner, 
.background-colour2 .filInBlanksContainer .component__instruction-inner.fillintheblanks__instruction-inner,
.background-colour2 .branchingContainer .component__instruction-inner,
.background-colour2 .matchingQuestion .component__instruction-inner,
.background-colour2 .truefalseContainer .truefalse__label-container,
.background-colour2 .truefalseContainer .truefalse__item-container
{
    background-color:#fff !important;
    color:#4F6074 !important;
}

.background-colour2 .mcqContainer .mcq-item__label, 
.background-colour2 .stackerContainer .stacker__item-text-inner,
.background-colour2 .branchingContainer .branching__item-narrative,
.background-colour2 .branchingContainer .branching__item-col-2-inner, .background-colour2 .matchingQuestion .element-color-control,
.background-colour2 .matchingQuestion .matching-item__select-container,
.background-colour2 .matchingQuestion .matching-item__title_inner {
    background-color: #fff !important;
}

.background-colour2 .graphicalMCQ label.gmcq-item__label {
    background-color: #fff !important;
    color:#041c39 !important;
}

.background-colour2 .openTextInput .opentextinput__count-characters {
    background-color:#fff !important;
    color:#4F6074 !important;
}

.background-colour2 .mcqContainer .Sub-Headline, 
.background-colour2 .mcqContainer .Body-Regular, 
.background-colour2 .mcqContainer .Question,
.background-colour2 .openTextInput .Sub-Headline,
.background-colour2 .openTextInput .Body-Regular, 
.background-colour2 .openTextInput .Question,
.background-colour2 .graphicalMCQ .Sub-Headline,
.background-colour2 .graphicalMCQ .Body-Regular, 
.background-colour2 .graphicalMCQ .Question,
.background-colour2 .truefalseContainer .Sub-Headline,
.background-colour2 .truefalseContainer .Body-Regular, 
.background-colour2 .truefalseContainer .Question,
.background-colour2 .sliderContainer .Sub-Headline,
.background-colour2 .sliderContainer .Body-Regular, 
.background-colour2 .sliderContainer .Question,
.background-colour2 .stackerContainer .Sub-Headline,
.background-colour2 .stackerContainer .Body-Regular, 
.background-colour2 .stackerContainer .Question,
.background-colour2 .fillInBlanksContainer .Sub-Headline,
.background-colour2 .fillInBlanksContainer .Body-Regular, 
.background-colour2 .fillInBlanksContainer .Question,
.background-colour2 .branchingContainer .Sub-Headline,
.background-colour2 .branchingContainer .Body-Regular, 
.background-colour2 .branchingContainer .Question,
.background-colour2 .matchingQuestion .Sub-Headline,
.background-colour2 .matchingQuestion .Body-Regular, 
.background-colour2 .matchingQuestion .Question,
.background-colour2 .graphicalMCQ span.gmcq-item__text-inner,
.background-colour2 .truefalseContainer .truefalse__labels,
.background-colour2 .stackerContainer .stacker__not-sliding .stacker__item-image-text,
.background-colour2 .stackerContainer .element-color-icon-dynamic,
.background-colour2 .stackerContainer .stacker__item-sorter-index,
.background-colour2 .stackerContainer .stacker__item-texts-holder,
.background-colour2 .branchingContainer .branching__item-narrative-title,
.background-colour2 .mcqContainer .mcq-item__label .mcq-item__text {
    color:#041c39 !important;
}

.background-colour2 .truefalseContainer .icon.element-color-text-icon {
    color:#AAB0C0 !important;
}

.background-colour2 .stackerContainer .stacker__item-sorter-up,
.background-colour2 .stackerContainer .stacker__item-sorter-down {
    color: #024597 !important;
}


.background-colour2 .matchingQuestion .btn__action,
.background-colour2 .matchingQuestion .btn__action:hover,
.background-colour2 .matchingQuestion .btn__action:focus {
    background-color: #dd221a !important;
}

.background-colour2 .matchingQuestion .btn__action.is-disabled,
.background-colour2 .matchingQuestion .btn__action.is-disabled:hover,
...
.trueFalseContainer .btn__response-container .btn-text,
.yesnoContainer .btn__response-container .btn-text,
...
.ediComponent .imageSection{
    background-image:url(@customImage5);
...
#adapt #app #wrapper .background-colour1 .ediComponent .component__inner .surveyLink.customlink,
#adapt #app #wrapper .background-colour1 .ediComponent .component__inner .surveyLink.customlink:hover,
#adapt #app #wrapper .background-colour1 .ediComponent .component__inner .surveyLink.customlink:focus,
#adapt #app #wrapper .background-colour1 .ediComponent .component__inner .surveyLink.customlink:visited,
#adapt #app #wrapper .background-colour2 .ediComponent .component__inner .surveyLink.customlink,
#adapt #app #wrapper .background-colour2 .ediComponent .component__inner .surveyLink.customlink:hover,
#adapt #app #wrapper .background-colour2 .ediComponent .component__inner .surveyLink.customlink:focus,
#adapt #app #wrapper .background-colour2 .ediComponent .component__inner .surveyLink.customlink:visited
{
    color: #fff !important;
}
...
.imagegallery__image-container .imagegallery__buttons .imagegallery__button-toggle-thumbs {
    background-image: url('https://urldefense.com/v3/__https://adaptassets.learningpool.com/football_association/assets/67/da/67da93a580915048803f065b.svg__;!!KyHJrpw!tHTPLHKdEF3RkLACEogC-Q_8VBNilhqh9Uspons6L3CgncgU7yoHJBpCrU15qKqgJfxVmE_zykxJvaOtdJOG7BYUf4zY$ ');
}
...
{
    background-image: url('https://urldefense.com/v3/__https://adaptassets.learningpool.com/football_association/assets/67/da/67da93a43a93e4e66054a1c8.svg__;!!KyHJrpw!tHTPLHKdEF3RkLACEogC-Q_8VBNilhqh9Uspons6L3CgncgU7yoHJBpCrU15qKqgJfxVmE_zykxJvaOtdJOG7F0m9OZ6$ ');
}

.imagegallery__image-container .imagegallery__buttons .imagegallery__button-popout {
    background-image: url('https://urldefense.com/v3/__https://adaptassets.learningpool.com/football_association/assets/67/da/67da93a549d86edec37fb5e5.svg__;!!KyHJrpw!tHTPLHKdEF3RkLACEogC-Q_8VBNilhqh9Uspons6L3CgncgU7yoHJBpCrU15qKqgJfxVmE_zykxJvaOtdJOG7IGZfIM9$ ');
}

.imagegallery__image-container .imagegallery__buttons .imagegallery__button-popout:hover {
    background-image: url('https://urldefense.com/v3/__https://adaptassets.learningpool.com/football_association/assets/67/da/67da9a1557e6bd90bab57ce9.svg__;!!KyHJrpw!tHTPLHKdEF3RkLACEogC-Q_8VBNilhqh9Uspons6L3CgncgU7yoHJBpCrU15qKqgJfxVmE_zykxJvaOtdJOG7DnwRL0A$ ');
}

.imagegallery__image-container .imagegallery__buttons .imagegallery__button-show-thumbs {
    background-image: url('https://urldefense.com/v3/__https://adaptassets.learningpool.com/football_association/assets/67/dc/67dc2c8900a2aeec666a149e.svg__;!!KyHJrpw!tHTPLHKdEF3RkLACEogC-Q_8VBNilhqh9Uspons6L3CgncgU7yoHJBpCrU15qKqgJfxVmE_zykxJvaOtdJOG7IoCHLWd$ ');
}

.imagegallery__image-container .imagegallery__buttons .imagegallery__button-show-thumbs:hover {
    background-image: url('https://urldefense.com/v3/__https://adaptassets.learningpool.com/football_association/assets/67/dc/67dc2c888ddbf39c9cf0f51d.svg__;!!KyHJrpw!tHTPLHKdEF3RkLACEogC-Q_8VBNilhqh9Uspons6L3CgncgU7yoHJBpCrU15qKqgJfxVmE_zykxJvaOtdJOG7MJUR9Pi$ ');
}
...
#wrapper .page .background-colour2 .narrativeContainer .narrative__progress.is-selected{
    background-color: #B3C5FF !important;
    margin:0;
}
...
.background-colour2 .accordion-item {
    border-radius: var(--spacing-spacing-scale-1, 4px);
    border: 2px solid #c85e58;
    background: rgba(255, 255, 255, 0.10);
    //margin: 8px;
    margin: 8px 0;
    background: #041C39;
...
.accordion-item__body .Body-Link-Regular,
.accordion-item__body .Body-Link-Regular:hover,
.accordion-item__body .Body-Link-Regular:focus,
...
.Sub-Headline,h5{
   font-size:clamp(1.35rem, 1.35rem + 0vw, 1.35rem) !important; 
   line-height: clamp(1.5rem, 1.5rem + 0vw, 1.5rem) !important;
}
